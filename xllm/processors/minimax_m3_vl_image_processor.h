...
class MiniMaxM3VLImageProcessor final : public ImageProcessor {
 public:
  explicit MiniMaxM3VLImageProcessor(const ModelArgs& args);
 ...
 private:
  ...
  bool process_image_batch(const std::vector<torch::Tensor>& images,
                           std::vector<torch::Tensor>& pixel_values,
                           std::vector<torch::Tensor>& thw) const;
