...
class ArgumentParser:
    def __init__(self) -> None:
        ...
        self.parser.add_argument('--kv_cache_memory_fraction', type=float, default=0.9, help='Fraction of free GPU memory (after loading model weights) to use for the KV cache.')
        self.parser.add_argument('--max_memory_utilization', type=float, default=None, help='[Deprecated] Alias for --kv_cache_memory_fraction (new semantics); overrides it when set.')
