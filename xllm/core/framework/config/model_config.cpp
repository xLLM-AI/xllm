...
DEFINE_bool(has_restored_npu_word_embedding,
            false,
            "Whether NPU word embedding has been restored.");
...
void ModelConfig::from_flags() {
  ...
  XLLM_CONFIG_ASSIGN_FROM_FLAG(has_restored_npu_word_embedding);
...
void ModelConfig::from_json(const JsonReader& json) {
  ...
  XLLM_CONFIG_ASSIGN_FROM_JSON(has_restored_npu_word_embedding);
...
void ModelConfig::append_config_json(
  ...
  APPEND_CONFIG_JSON_VALUE_IF_NOT_DEFAULT(
      config_json, default_config, has_restored_npu_word_embedding);
  APPEND_CONFIG_JSON_VALUE_IF_NOT_DEFAULT(
