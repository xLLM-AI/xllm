...
void WorkerServer::create_spawn_server(int32_t local_rank,
  ...
  std::string enable_mtp_draft_tp1_str =
      std::to_string(options.enable_mtp_draft_tp1());
  const char* enable_mtp_draft_tp1_ptr = enable_mtp_draft_tp1_str.c_str();
